(function() {
    ...
    */
    let sul = ['Parana', 'Santa Catarina', 'Rio Grande do Sul', 'Curitiba'];
    let sudeste = ['São Pauo', 'Minas Gerais', 'Rio de Janeiro', 'Espírito Santo'];
    ...
    */
    ...
    chamada `newSudeste`.
    */
    let = newSudeste = brasil.splice(6);
