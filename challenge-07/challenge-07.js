...
*/
var myArray = ['Bispo', 150, {cor: 'preto'}, true, function(x, y) {return x * y ;}]
/*
...
*/
console.log(addItem(['String', {carro: 'Ferrary'}, false]));
...
*/
console.log('O segundo elemento do segundo array e', myArray[5][1], '.');
