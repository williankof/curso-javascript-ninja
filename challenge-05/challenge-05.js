...
array criado.
*/
console.log(otherFunction(myVar, 0));
console.log(otherFunction(myVar, 1));
console.log(otherFunction(myVar, 2));
console.log(otherFunction(myVar, 3));
console.log(otherFunction(myVar, 4));
console.log()
...
function book(param) {    
    ...
    return !param ? livros : livros[param];
